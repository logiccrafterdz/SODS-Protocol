...
[![SODS MEV Detection Demo](https://img.youtube.com/vi/dhE_uNHLjec/0.jpg)](https://www.youtube.com/watch?v=dhE_uNHLjec)
...
- **Behavioral Merkle Trees (BMT)**: Current proof structure (active v1.0-v7.0).
